...
float L2=80; //Elbow to wrist length
// float L3=68;  //Length from wrist to hand PLUS base centre to shoulder (versions 0.3-1.2)
float L3=22;  // Correct to MeArm Version 3.0
